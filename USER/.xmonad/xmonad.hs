...
myPlacement = fixed(0, 0) --inBounds (underMouse (0.21, 0.21))
-- 
...
myStartupHook = do
    ...
    --    spawnOnce "feh --bg-fill /usr/share/endeavouros/backgrounds/nature1.png"
...
myManageHook = composeAll
     ...
     , className =? "pavucontrol"     --> placeHook myPlacement
...
myKeys =
    ...
    -- Power Off
        , ("M1-<F9>", spawn "systemctl poweroff")
        , ("M1-<F7>", spawn "systemctl suspend")
        , ("M1-<F8>", spawn "reboot")
    -- KB_GROUP Other Dmenu Prompts
    -- In Xmonad and many tiling window managers, M-p is the default keybinding to
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        , ("M-S-p", spawn "dm-hub")           -- allows access to all dmscripts
   ...
   --  , ("M-S-s", spawn "maim -s ~/Pictures/temp/boom.png  && xclip -selection clipboard -t image/png -i ~/Pictures/temp/boom.png && feh ~/Pictures/temp/$(date +%s).png")
        , ("M1-S-s", spawn "flameshot gui")
   -- App Finder Menu using rofi 

	, ("M-z", spawn "rofi -modi drun -show drun -config ~/.config/rofi/rofidmenu.rasi" ) 
	, ("M-v", spawn "pcmanfm")
   -- KB_GROUP Useful programs to have a keybinding for launch
    ...
    -- KB_GROUP Windows navigation
        ...
        , ("M-`", windows W.focusDown)      -- Move focus to the prev window
        , ("M-a", windows W.focusUp)      -- Move focus to the prev window
        , ("M-S-m", windows W.swapMaster) -- Swap the focused window and the master window
        , ("M-S-j", windows W.swapDown)   -- Swap focused window with next window
        , ("M-S-d", windows W.swapDown)   -- Swap focused window with next window
	...
	, ("M-<Tab>", spawn "rofi -show window -config .config/rofi/switchwindow.rasi")
    ...
    -- KB_GROUP Window resizing
        ...
        , ("M-w", sendMessage MirrorExpand)          -- Expand vert window width
